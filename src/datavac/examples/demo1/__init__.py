...
assert get_current_context_name()=='builtin:demo1',\
    "To use demo1 content, switch to the builtin:demo1 context:\n"\
    "> datavac context use builtin:demo1"
dbname='datavacuum_demo1'
EXAMPLE_DATA_DIR = Path(os.environ['DATAVACUUM_TEST_DATA_DIR']) / 'demo1'
#import os
#from pathlib import Path
#import platformdirs
